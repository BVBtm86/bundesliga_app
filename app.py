...
def main() -> None:
    try:
        ...
        st.warning("Try refreshing the page or checking your internet connection.")
...
if __name__ == "__main__":
    try:
        ...
        st.error("🚨 **Critical Error! The app failed to load.**")
        st.warning("Please check your settings or restart the app.")
        st.text(f"Error details: {str(e)}")